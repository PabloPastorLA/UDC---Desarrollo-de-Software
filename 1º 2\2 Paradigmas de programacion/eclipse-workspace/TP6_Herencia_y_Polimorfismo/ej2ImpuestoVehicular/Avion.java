...
public class Avion extends Vehiculo {
	...
	//constantes
	//atrib clase
	static private double indice = INDICE_AVION;
	//constructores
	public Avion(String marca, String modelo, String patente, int año, int valor, String nombre, String domicilio) {
	...
	public double calcularImpuesto() {
		return ((getAño()) * indice * getValor() / 100) / 100;
	}
